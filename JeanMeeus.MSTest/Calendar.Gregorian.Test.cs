...
namespace JeanMeeusUnitTests
{
    ...
    public class GregorianCalendarTests
    {
        ...
        {
            TestDate(GregorianCalendar.Create(2436116.31), 1957, Month.October, 4.81);
            TestDate(GregorianCalendar.Create(2418781.5), 1910, Month.April, 20.0);
            TestDate(GregorianCalendar.Create(2446470.5), 1986, Month.Febuary, 9.0);
        ...
        {
            var d1 = GregorianCalendar.Create(1910, Month.April, 20.0);
            var d2 = GregorianCalendar.Create(1986, Month.Febuary, 9.0);
